...
GROUP BY
    ...
    param = { total_param.FromDate, total_param.ToDate }
}
local result = {}
db.query(param)
local record = {}
...
local style = teamyar.get_attachment( 'style.css')
local main = teamyar.get_attachment( 'main.js')
local highcharts = teamyar.get_attachment( 'highcharts.js')
local exporting = teamyar.get_attachment( 'exporting.js')
local exportdata = teamyar.get_attachment( 'export-data.js')
local accessibility = teamyar.get_attachment( 'accessibility.js')
local template = [[
<!DOCTYPE html>
<html lang="en">
<head>
